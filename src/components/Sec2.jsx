...
const Sec2 = () => {
    return (
        <div className="max-w-[1140px] mx-auto px-3 flex flex-wrap lg:pt-[129px] pt-14">
            <div className="w-full  lg:w-1/2  justify-center items-center lg:items-start flex flex-col">
                <h2 className="lg:text-[64px] sm:text-[45px] text-[36px] font-normal lg:mb-0 mb-4 leading-[108%] text-white font-azo">
                    About
                </h2>
